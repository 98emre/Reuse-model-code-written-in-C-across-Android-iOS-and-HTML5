...
**OBS!!** Först måste du ladda ner projektet från GitHub innan du börjar. Den här manualen är till för de som ska ladda ner och köra projektet på Android Studio första gången. Därefter kommer applikationen att kunna köras som vanligt även om man stänger IDE. 
