...
JNIEXPORT jobject JNICALL Java_com_example_weatherappcapi_WeatherNative_createWeatherObjectFromC(JNIEnv *env, jobject obj, jstring approvedTime) {
    ...
    // Skapa ett Java-objekt av klassen WeatherNative
    jclass weatherNativeClass = (*env)->FindClass(env, "com/example/weatherappcapi/WeatherNative");
    ...
    jclass hourlyWeatherDataClass = (*env)->FindClass(env, "com/example/weatherappcapi/WeatherNative$HourlyWeatherData");
    ...
    // Rensa upp refrenser
    (*env)->DeleteLocalRef(env, approvedTime);
...
JNIEXPORT jdouble JNICALL Java_com_example_weatherappcapi_WeatherNative_getLat(JNIEnv *env, jobject obj, jobject weatherDataObj) {
...
JNIEXPORT void JNICALL Java_com_example_weatherappcapi_WeatherNative_setLat(JNIEnv *env, jobject obj, jobject weatherDataObj, jdouble lat) {
...
Java_com_example_weatherappcapi_WeatherNative_getLon(JNIEnv *env, jobject obj, jobject weatherDataObj) {
...
Java_com_example_weatherappcapi_WeatherNative_setLon(JNIEnv *env, jobject obj, jobject weatherDataObj, jdouble lon) {
...
Java_com_example_weatherappcapi_WeatherNative_getApprovedTime
(JNIEnv *env, jobject obj, jobject weatherDataObj) {
...
JNIEXPORT void JNICALL
Java_com_example_weatherappcapi_WeatherNative_setApprovedTime
(JNIEnv *env, jobject obj, jobject weatherDataObj, jstring approvedTime) {
...
JNIEXPORT jint JNICALL Java_com_example_weatherappcapi_WeatherNative_getHourlyDataSize(JNIEnv *env, jobject obj, jobject weatherDataObj) {
...
JNIEXPORT jstring JNICALL
Java_com_example_weatherappcapi_WeatherNative_getTime(JNIEnv *env, jobject obj, jobject hourlyDataObj) {
...
JNIEXPORT void JNICALL
Java_com_example_weatherappcapi_WeatherNative_setTime(JNIEnv *env, jobject obj, jobject hourlyDataObj, jstring time) {
...
JNIEXPORT jstring JNICALL Java_com_example_weatherappcapi_WeatherNative_getTemperature(JNIEnv *env, jobject obj, jobject hourlyDataObj) {
...
JNIEXPORT void JNICALL Java_com_example_weatherappcapi_WeatherNative_setTemperature(JNIEnv *env, jobject obj, jobject hourlyDataObj, jstring temperature) {
...
JNIEXPORT jstring JNICALL Java_com_example_weatherappcapi_WeatherNative_getIcon(JNIEnv *env, jobject obj, jobject hourlyDataObj) {
...
JNIEXPORT void JNICALL Java_com_example_weatherappcapi_WeatherNative_setIcon(JNIEnv *env, jobject obj, jobject hourlyDataObj, jstring icon) {
...
JNIEXPORT jobject JNICALL Java_com_example_weatherappcapi_WeatherNative_createHourlyWeatherObjectFromC(JNIEnv *env, jobject obj, jstring time, jstring temperature, jstring icon) {
    // Create a new HourlyWeatherData object
    jclass hourlyDataClass = (*env)->FindClass(env, "com/example/weatherappcapi/WeatherNative$HourlyWeatherData");
...
JNIEXPORT jobject JNICALL Java_com_example_weatherappcapi_WeatherNative_getHourlyData(JNIEnv *env, jobject obj, jobject weatherDataObj, jint index) {
...
JNIEXPORT void JNICALL Java_com_example_weatherappcapi_WeatherNative_addHourlyData(JNIEnv *env, jobject thisObj, jobject dataObj, jobject hourlyDataObj) {
